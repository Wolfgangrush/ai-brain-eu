"""ailawfirm_eu.brain.repl — terminal front door for the brain.

A small, dependency-free Read–Eval–Print Loop that talks to the brain's
:class:`ailawfirm_eu.brain.router.think` function. The user types a
...
from ailawfirm_eu.brain.router import think
...
_BANNER = (
    "ailawfirm_eu brain — terminal front door\n"
