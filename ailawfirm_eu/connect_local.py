...
Usage from CLI:
    ...
    ailawfirm-eu connect-local --yes      # skip prompts
    ailawfirm-eu connect-local --model qwen3:7b   # force a specific model

Result: ~/.ailawfirm-eu/config.json is written with ai_provider=ollama and the
...
def install_ollama_instructions() -> None:
    ...
    print()
    print("Then run `ailawfirm-eu connect-local` again.")
...
def cmd_connect_local(args) -> int:
    ...
    print("  ailawfirm-eu connect-cloud --provider deepseek --cloud-warning-acknowledged")
    print()
    return 0
