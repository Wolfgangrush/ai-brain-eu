...
Usage:
    python3 -m ailawfirm_eu.onboarding
    or: brain init
"""

from pathlib import Path
from ailawfirm_eu.entity_registry import EntityRegistry
from ailawfirm_eu.entity_detector import detect_entities, scan_for_detection
...
def _warn_ambiguous(people: list) -> list:
    ...
    """
    from ailawfirm_eu.entity_registry import COMMON_ENGLISH_WORDS
...
""")
    ...
    print("\n  entity-aliasing entity registry: ~/.ailawfirm-eu/alias_entities.md")
    print("  Critical facts bootstrap: ~/.ailawfirm-eu/critical_facts.md")
