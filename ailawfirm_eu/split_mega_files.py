...
# Loaded from ~/.ailawfirm-eu/known_names.json if it exists, otherwise generic fallback.
...
def _load_known_people() -> list:
    ...
    if _KNOWN_NAMES_PATH.exists():
        try:
            ...
            pass
    # Generic fallback — override by creating ~/.ailawfirm-eu/known_names.json
...
def extract_people(lines):
    ...
    if dir_match:
        ...
        # User can map usernames to names in ~/.ailawfirm-eu/known_names.json
