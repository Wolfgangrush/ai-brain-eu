...
class Layer0:
    ...
    Reads from ~/.ailawfirm-eu/identity.txt — a plain-text file the user writes.
    ...
    def __init__(self, identity_path: str = None):
        if identity_path is None:
            identity_path = os.path.expanduser("~/.ailawfirm-eu/identity.txt")
    ...
    def render(self) -> str:
        ...
        if os.path.exists(self.path):
            ...
            self._text = (
                "## L0 — IDENTITY\nNo identity configured. Create ~/.ailawfirm-eu/identity.txt"
            )
...
class MemoryStack:
    ...
    def __init__(self, palace_path: str = None, identity_path: str = None):
        cfg = AilawfirmEuConfig()
        self.palace_path = palace_path or cfg.palace_path
        self.identity_path = identity_path or os.path.expanduser("~/.ailawfirm-eu/identity.txt")
