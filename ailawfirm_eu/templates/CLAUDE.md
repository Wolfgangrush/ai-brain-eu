...
This runs `pip install --upgrade git+https://github.com/Wolfgangrush/ai-brain-eu.git` under the hood. Your matter data is NEVER touched — only firm code/skills/prompts get refreshed.
