...
> This file was generated by `ailawfirm-eu init`. It tells the AI (Claude / Gemini / DeepSeek / local model) how this firm works. Edit it as your practice evolves — your edits survive `ailawfirm-eu update`.
...
This runs `pip install --upgrade git+https://github.com/Wolfgangrush/ai-law-firm-eu.git` under the hood. Your matter data is NEVER touched — only firm code/skills/prompts get refreshed.
