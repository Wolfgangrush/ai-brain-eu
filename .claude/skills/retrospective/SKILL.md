---
name: retrospective
description: End-of-session save discipline for EU AI Brain users. Runs 2-pass leak-check (Rule 6: no internal-shorthand, no internal-paths, no personal-build references). Saves session learning so the firm gets smarter with every use.
allowed-tools: Bash, Read, Glob
---

# /retrospective — End-of-Session Save Discipline (EU)

Saves what the EU AI Brain learned this session. Runs at session end. The firm accumulates knowledge across sessions without leaking personal context.
...
- What legal domains were touched (GDPR, EU AI Act, DMA, DSA, Brussels I Recast, Rome I/II, cross-border establishment under Directive 98/5/EC, competition, data protection, consumer law)
- What courts or jurisdictions were referenced (CJEU, General Court, national courts of 27 Member States)
- Any errors or blockers encountered

### Step 2: Run 2-pass leak-check (above)

### Step 3: If passes leak-check, write session summary
Save to `.ailawfirm-eu/sessions/` with timestamp. Format:
```markdown
...
## Output Format
```markdown
## /retrospective — EU AI Brain · Session Save
