# Contributing to AI Brain — EU

Thanks for wanting to help. **AI Brain — EU** is open source (MIT). Contributions of all sizes are welcome — typo fixes, statute-corpus corrections, new drafting templates, agent improvements, and translations.
...
```
ailawfirm_eu/   ← core package (see ailawfirm_eu/README.md for the module/agent guide)
tests/         ← test suite
