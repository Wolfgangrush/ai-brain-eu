...
For **any** substantive query — ECLI / CELEX citation, CJEU / national-court jurisdiction, Brussels I-bis / Rome I / Rome II / GDPR deadlines, drafting, EU AI Act / GDPR / AML / CCBE compliance, matter lookup, or **any** question of EU law — do **NOT** answer from your own knowledge. Run:
...
```bash
python3 -m ailawfirm_eu reception   # greet + systems-check + memory + recap
python3 -m ailawfirm_eu ask "<q>"   # route one query through the brain
python3 -m ailawfirm_eu chat        # interactive REPL
python3 -m ailawfirm_eu recap       # retrospective-memory of recent sessions
```
